...
<div class="profile-content">
    ...
    <?php if (isset($_SESSION['user']['reservations']) && !empty($_SESSION['user']['reservations'])): ?>
        <?php foreach ($_SESSION['user']['reservations'] as $reservation): ?>
            <div class="reservation-card">
                ...
                <div>
                    ...
                    <div class="trek-meta">
                        <span><i class="icon">📅</i> <?= date('d/m/Y', strtotime($reservation['date_depart'])) ?></span>
                        <span><i class="icon">👥</i> <?= $reservation['nb_personnes'] ?> personne(s)</span>
                        <span class="reservation-status status-confirmed">Confirmée</span>
                    </div>
                    <p><?= getReservationDescription($reservation['destination']) ?></p>
