...
<body>
    ...
    <!-- Nouveau bouton qui envoie directement vers CYBank -->
    <form action="https://www.plateforme-smc.fr/cybank/index.php" method="POST" style="display: inline;">
        ...
        $vendeur = "TEST"; // À remplacer par votre code vendeur réel en production
        $api_key = getAPIKey($vendeur);
        $retour_url = 'https://' . $_SERVER['HTTP_HOST'] . '/Projet1/click_journey/recap-reservation.php';
